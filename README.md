...
**Note:** As I listen to and review more albums (which is frequently), I will try to update the CSV file in the project to reflect the changes. As of writing, I have rated 178 albums.
